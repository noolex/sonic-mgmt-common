...
func Test_KeyExpntVal_OCYang(t *testing.T) {
	...
	url = "/openconfig-network-instance:network-instances/network-instance[name=Vrf_test1]/protocols/protocol[identifier=BGP][name=bgp]/bgp/global/afi-safis/afi-safi[afi-safi-name=L2VPN_EVPN]/l2vpn-evpn/openconfig-bgp-evpn-ext:vnis"
	url_body_json = "{\"openconfig-bgp-evpn-ext:vni\":[{\"vni-number\":14628525,\"config\":{\"vni-number\":14628525,\"advertise-default-gw\":true}}]}"
	...
	url = "/openconfig-network-instance:network-instances/network-instance[name=Vrf_test1]/protocols/protocol[identifier=BGP][name=bgp]/bgp/global/afi-safis/afi-safi[afi-safi-name=L2VPN_EVPN]/l2vpn-evpn/openconfig-bgp-evpn-ext:vnis/vni[vni-number=14628525]/config/advertise-default-gw"

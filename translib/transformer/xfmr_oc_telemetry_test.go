...
func Test_OC_Telemetry_Get_Sensor_Group(t *testing.T) {
	...
	t.Run("Verify Get Sensor Group", processGetRequest(url, expected, false))
...
func Test_OC_Telemetry_Get_Destination_Group(t *testing.T) {
	...
	t.Run("Verify Get Destination Group", processGetRequest(url, expected, false))
...
func Test_OC_Telemetry_Get_Persistent_Subscription(t *testing.T) {
	...
	t.Run("Verify Get Persistent Subscription", processGetRequest(url, expected, false))

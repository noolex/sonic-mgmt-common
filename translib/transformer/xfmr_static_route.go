...
func getYgotStaticRoutesObj(s *ygot.GoStruct, vrf string, is_validate bool) (
	*ocbinds.OpenconfigNetworkInstance_NetworkInstances_NetworkInstance_Protocols_Protocol_StaticRoutes, error) {
	...
	if deviceObj.NetworkInstances == nil {
		if is_validate {
			return nil, errors.New("Network Instances object not found")
		}
	...
	if !ok {
		if is_validate {
			return nil, errors.New("Network Instance object not found")
		}
	...
	if vrfInstObj.Protocols == nil {
		if is_validate {
			return nil, errors.New("Protocols object not found")
		}
	...
	if !ok {
		if is_validate {
			return nil, errors.New("STATIC Protocol not found")
		}
	...
	if protoInstObj.StaticRoutes == nil {
		if is_validate {
			return nil, errors.New("Static routes object not found")
		}
			...
			if nexthopObj.Config != nil {
				...
				if nexthopObj.Config.NextHop != nil {
					...
					case *ocbinds.OpenconfigNetworkInstance_NetworkInstances_NetworkInstance_Protocols_Protocol_StaticRoutes_Static_NextHops_NextHop_Config_NextHop_Union_String:
						gwIp = nexthopObj.Config.NextHop.(*ocbinds.OpenconfigNetworkInstance_NetworkInstances_NetworkInstance_Protocols_Protocol_StaticRoutes_Static_NextHops_NextHop_Config_NextHop_Union_String).String
					default:
